...
class PuzzleControllerTest {
    ...
    void getRandomPuzzles_returnsThreePuzzles() throws Exception {
        ...
        Puzzle testPuzzle1 = new Puzzle("1", "test body1", "test solution1");
        Puzzle testPuzzle2 = new Puzzle("2", "test body2", "test solution2");
        Puzzle testPuzzle3 = new Puzzle("3", "test body3", "test solution3");
